...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    @Transactional
    public void processWebhook(FhirAppointmentDto dto, String messagingProvider, String hospitalId, String providerConfigJson) {
    ...
    private void handleCancellation(FhirAppointmentDto dto, String messagingProvider, String hospitalId, String providerConfigJson) {
